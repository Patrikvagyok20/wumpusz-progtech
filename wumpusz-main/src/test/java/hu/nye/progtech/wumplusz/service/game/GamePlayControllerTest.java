...
public class GamePlayControllerTest {
    ...
    private static final List<GamePlayInstructions> GAME_PLAY_INSTRUCTIONS = List.of(
            GamePlayInstructions.LEP,
            GamePlayInstructions.HALASZTAS,
    ...
    public void testGameStepShouldLEP() throws ExitChoiceThrowable, DeathThrowable, VictoryThrowable {
        ...
        given(userInteractionHandler.getChosenGamePlayInstruction(GamePlayController.GAME_PLAY_INSTRUCTIONS_LIST)).willReturn(GamePlayInstructions.LEP).willThrow(ExitChoiceThrowable.class);
    ...
    public void testGameStepShouldLO() throws ExitChoiceThrowable {
        // given
        given(gameStore.getMapVO()).willReturn(mapVO);
        given(userInteractionHandler.getChosenGamePlayInstruction(GamePlayController.GAME_PLAY_INSTRUCTIONS_LIST)).willReturn(GamePlayInstructions.LO).willThrow(ExitChoiceThrowable.class);
        // when
        underTest.gameStep();
        // then
