            ...
            switch (chosenMenu) {
                case 1:
                    if (gameStore.getAvailableEntities() == null && gameStore.getMapVO() != null) {
                        System.out.println("A palya mar keszen van!");
                ...
                case 2:
                    try {
                        ...
                        if (MapValidator.isValid(mapVO)) {
                            ...
                            System.out.println("Hibas a txt fajl, az entitas szam nem megfelelo! " +
                                    "Javitsd ki, es inditsd ujra a jatekot!");
                            chosenMenu = 7;
                            break;
                        }
                ...
                case 7:
                    break;
                default:
                    System.out.println("Kerlek 1-7 kozotti szamot adj meg!");
                    break;
            }
        }
        System.out.println("Kileptel!");
    }
}
