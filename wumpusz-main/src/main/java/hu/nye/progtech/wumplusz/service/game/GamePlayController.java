...
public class GamePlayController {
    ...
    public static final List<GamePlayInstructions> GAME_PLAY_INSTRUCTIONS_LIST = List.of(GamePlayInstructions.LEP,
            GamePlayInstructions.FORDUL_JOBBRA, GamePlayInstructions.FORDUL_BALRA, GamePlayInstructions.LO,
    ...
    public void gameStep() {
        ...
        while (true) {
            ...
            System.out.println("A hos iranya: " + mapVO.getHero().getHeroDirection().getLabel());
            System.out.println("Nyilak szama: " + mapVO.getHero().getArrowCount());
            System.out.println("Kezdo pozicio: x: " + mapVO.getHero().getStartingRow()
            ...
            switch (gamePlayInstructions) {
                case LEP:
                    try {
                        ...
                        System.out.println("Visszaertel a kezdo poziciora, nyertel! Lepeseid szama: "
