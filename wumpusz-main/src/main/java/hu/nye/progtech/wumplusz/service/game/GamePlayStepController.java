...
public class GamePlayStepController {
    ...
    public void shoot(MapVO mapVO) {
        ...
        while (true) {
            ...
            if (ch == 'W') {
                ...
                System.out.println("Eltalaltal egy wumpuszt!\n");
                return;
            }
            switch (heroDirection) {
                case N:
    ...
    public void pickUp(MapVO mapVO) {
        ...
        if (hasGold) {
            ...
            System.out.println("Nem vettel fel semmit!");
        }
    }
    ...
    public Boolean checkStep(MapVO mapVO) throws DeathThrowable {
        ...
        switch (ch) {
            case 'W':
                ...
                return false;
            case 'P':
                System.out.println("Verembe leptel! Elveszettel egy nyilat!\n");
                mapVO.getHero().decreaseArrowCount();
                return false;
            case 'U':
                System.out.print("Wumpusszal talalkoztal! ");
                throw new DeathThrowable();
            case 'G':
                System.out.println("Arany van elotted!\n");
                return false;
            default:
                return true;
        }
